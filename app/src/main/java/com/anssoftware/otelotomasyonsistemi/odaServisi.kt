...
import kotlinx.android.synthetic.main.activity_oda_servisi.*
import kotlinx.android.synthetic.main.activity_oda_servisi.nfc_image
import kotlinx.android.synthetic.main.activity_oda_servisi.okutmaBekleniyor
...
class odaServisi : AppCompatActivity() {
    ...
    fun onClickOdaServisiSatisiTamamla(view: View) {
        ...
        }else if(secilenHizmet=="LÜTFEN BİR SERVİS SEÇİNİZ"){
            Toast.makeText(this,"LÜTFEN ÖNCE BİR SERVİS SEÇİNİZ",Toast.LENGTH_LONG).show()
        }else if(oda_servisi_adedi.text.toString()==""){
            Toast.makeText(this,"LÜTFEN ÖNCE SERVİS ADEDİNİ GİRİNİZ",Toast.LENGTH_LONG).show()
    ...
    fun tutarHesapla(){
        ...
        if(secilenHizmet=="Hamburger"){
            uruntekliTutar=50
        }else if(secilenHizmet=="Pizza"){
            uruntekliTutar=80
        }else if(secilenHizmet=="Kola"){
            uruntekliTutar=15
        }else if(secilenHizmet=="Ayran"){
            uruntekliTutar=12
        }else if(secilenHizmet=="Tavuk Döner"){
            uruntekliTutar=40
        }else if(secilenHizmet=="Sahanda Yumurta"){
            uruntekliTutar=30
        }else if(secilenHizmet=="Kahvaltı Tabağı"){
            uruntekliTutar=120
        }else if(secilenHizmet=="Serpme Kahvaltı"){
            uruntekliTutar=200
        }else if(secilenHizmet=="Günün Çorbası"){
            uruntekliTutar=50
        }else if(secilenHizmet=="Meyve Suyu"){
            uruntekliTutar=30
        }else if(secilenHizmet=="Soda"){
            uruntekliTutar=12
        }
