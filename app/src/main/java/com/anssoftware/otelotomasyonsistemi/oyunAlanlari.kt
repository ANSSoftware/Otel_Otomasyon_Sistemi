...
import kotlinx.android.synthetic.main.activity_oyun_alanlari.*

class oyunAlanlari : AppCompatActivity() {

    lateinit var odaServisi_satin_al_sp: Spinner
    var hizmetler = arrayListOf("LÜTFEN BİR OYUN HİZMETİ SEÇİNİZ")
    var secilenHizmet = ""
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_oyun_alanlari)
        listeOlustur()
        urun_satin_al_spfun()
    ...
    fun listeOlustur(){
        hizmetler.add("Halı Saha")
        hizmetler.add("Playstation Salonu")
        hizmetler.add("Odaya Playstation Hizmeti")
        hizmetler.add("Çocuk Oyun Alanı")
        hizmetler.add("Gamer Odası")
    }
    ...
    fun onClickOdaServisiSatisiTamamla(view: View) {
        ...
        }else if(secilenHizmet=="LÜTFEN BİR OYUN HİZMETİ SEÇİNİZ"){
            Toast.makeText(this,"LÜTFEN ÖNCE BİR OYUN HİZMETİ SEÇİNİZ", Toast.LENGTH_LONG).show()
        }else if(oda_servisi_adedi.text.toString()==""){
            Toast.makeText(this,"LÜTFEN ÖNCE OYUN HİZMETİ SAATİNİ GİRİNİZ", Toast.LENGTH_LONG).show()
    ...
    fun tutarHesapla(){
        ...
        if(secilenHizmet=="Halı Saha"){
            uruntekliTutar=500
        }else if(secilenHizmet=="Playstation Salonu"){
            uruntekliTutar=50
        }else if(secilenHizmet=="Odaya Playstation Hizmeti"){
            uruntekliTutar=150
        }else if(secilenHizmet=="Çocuk Oyun Alanı") {
            uruntekliTutar = 50
        }else if(secilenHizmet=="Gamer Odası"){
            uruntekliTutar = 30
        }
